...
class AlumniRegisterPage extends StatefulWidget {
  const AlumniRegisterPage({Key? key}) : super(key: key);
...
class _AlumniRegisterPageState extends State<AlumniRegisterPage> {
  ...
  Future addUserDetails(String name, String email, String passsword,
      String mobile, String college, String year,String urlResume,String urlProfile) async {
    await FirebaseFirestore.instance.collection('Alumni').doc('${name}${mobile}').set({
      'email': email,
      'passsword': passsword,
                        ...
                        child: TextFormField(
                            validator: (value){
                              if(value!.isEmpty&&!RegExp(r'^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$').hasMatch(value))
                                return 'value cannot be empty or string';
                              return null;
                            },
